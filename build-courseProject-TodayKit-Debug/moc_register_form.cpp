...
#include "../courseProject/register_form.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Register_Form_t, stringdata0) + ofs \
...
QT_MOC_LITERAL(4, 56, 12) // "Registration"

    },
    "Register_Form\0WelcomeWindow\0\0"
    "on_register_button_clicked\0Registration"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_Register_Form[] = {
...
const QMetaObject Register_Form::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_Register_Form.data,
      qt_meta_data_Register_Form,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Register_Form::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Register_Form.stringdata0))
        return static_cast<void*>(const_cast< Register_Form*>(this));
